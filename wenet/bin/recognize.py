...
def get_args():
    ...
    parser.add_argument('--load_from_wandb', action='store_true', help='not yet implemented')
...
def main():
    ...
    test_conf['merge_utterances'] = False
    test_conf['spec_sub'] = False
    test_conf['spec_trim'] = False
    if args.data_type=='raw':
        if 'shuffle' in test_conf:
            del test_conf['shuffle']
    else:
